...
void main() {
  test('in codebase with no cycles', () async {
    final result = await CycleDetector().detect(
      'test_resources/example_codebase_no_cycles',
    );
  ...
  test('in codebase with cycles', () async {
    final result = await CycleDetector().detect(
      'test_resources/example_codebase_with_cycles',
    );
  ...
  test('big codebase', () async {
    final result = await CycleDetector().detect(
      'test_resources/example_big_codebase',
      maxDepth: 8,
    );
